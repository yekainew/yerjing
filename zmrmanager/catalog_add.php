...
else if($dopost=='savequick')
{
    ...
    $queryTemplate = "INSERT INTO `#@__arctype`(reid,topid,sortrank,typename,typenameng,typedir,isdefault,defaultname,issend,channeltype,
    ...
    VALUES('~reid~','~topid~','~rank~','~typename~','~typenameng~','~typedir~','$isdefault','$defaultname','$issend','$channeltype',
