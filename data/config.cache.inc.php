...
$cfg_basehost = 'http://www.yerjing.com';
$cfg_cmspath = '';
$cfg_cookie_encode = '2wfFmdERw89WNgEGtkqYw7pSd1hNn';
$cfg_indexurl = '';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '伊尔净智能水凝胶';
$cfg_adminemail = 'yekainew@qq.com';
...
$cfg_fck_xhtml = 'N';
$cfg_df_style = 'yerjing';
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; 2015 伊尔净智能水凝胶 版权所有';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '妇科炎症、宫颈糜烂、宫颈炎、阴道紧缩、阴道炎、盆腔炎、月经不调、私处护理';
$cfg_description = '深圳市掌门人电子商务有限公司成立于2013年，注册资金100万，是一家专业销售伊尔净与服务咨询的公司。';
$cfg_beian = '粤ICP备15081066号-1';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
$cfg_typedir_df = 'Y';
